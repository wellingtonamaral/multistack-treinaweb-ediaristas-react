...
import { PasswordStrengthBar, PasswordStrengthLabel } from './PasswordStrength.style';
    ...
    <div style={{ gridArea: "password-strength" }}>
      <Typography variant={"body2"} component={"span"} color={"textSecondary"}>
        ...
        <PasswordStrengthLabel value={strengthValue}>
          ...
          {strength === 1 && "MÉDIA"}
          {strength === 2 && "FORTE"}
          {strength === 3 && "ANTI HACKER"}
        </PasswordStrengthLabel>
      </Typography>
      <PasswordStrengthBar value={strengthValue} variant={"determinate"} />
    </div>
  );
};
